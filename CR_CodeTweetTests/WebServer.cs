...
{
	/// <summary>
	/// Web server that can be used for testing web requests.
	/// </summary>
	/// <see href="http://www.paraesthesia.com/archive/2008/07/16/simplest-embedded-web-server-ever-with-httplistener.aspx"/>
